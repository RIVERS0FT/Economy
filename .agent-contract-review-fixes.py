...
if anchor not in text:
    raise SystemExit('missing commercial test insertion anchor')
test_file.write_text(text.replace(anchor, insert + anchor, 1), encoding='utf-8', newline='\n')
