...
const FACILITY_METHOD_BLUEPRINTS = Object.freeze({
  farm: Object.freeze([
    ...
    dedicatedMethod({ id: 'tool-tillage', nameTemplate: '{product:tools}耕作', iconId: 'tool', descriptionTemplate: '每周期整件消耗 1 {product:tools}并提高作物产量。', tone: 'warning', additionalInputs: [{ productId: 'tools', quantity: 1 }], outputQuantity: 12, requiredTechnologyIds: ['powered-production'] }),
    dedicatedMethod({ id: 'precision-fertilization', nameTemplate: '精准{product:fertilizer}作业', iconId: 'fertilizer', descriptionTemplate: '每周期整件消耗 2 {product:fertilizer}并进一步提高产量。', tone: 'success', additionalInputs: [{ productId: 'fertilizer', quantity: 2 }], outputQuantity: 14, requiredTechnologyIds: ['applied-chemistry'] }),
    dedicatedMethod({ id: 'tractor-farming', nameTemplate: '{product:tractor}耕作', iconId: 'tractor', descriptionTemplate: '每周期整件消耗 1 {product:tractor}并获得最高作物产量。', tone: 'accent', additionalInputs: [{ productId: 'tractor', quantity: 1 }], outputQuantity: 16, requiredTechnologyIds: ['mechanized-production'] }),
  ]),
  orchard: Object.freeze([
    ...
    dedicatedMethod({ id: 'tool-pruning', nameTemplate: '{product:tools}修枝', iconId: 'pruning', descriptionTemplate: '每周期整件消耗 1 {product:tools}并提高{product:fruit}产量。', tone: 'warning', additionalInputs: [{ productId: 'tools', quantity: 1 }], outputQuantity: 11, requiredTechnologyIds: ['powered-production'] }),
    dedicatedMethod({ id: 'precision-fertilization', nameTemplate: '精准{product:fertilizer}作业', iconId: 'fertilizer', descriptionTemplate: '每周期整件消耗 2 {product:fertilizer}并进一步提高产量。', tone: 'success', additionalInputs: [{ productId: 'fertilizer', quantity: 2 }], outputQuantity: 13, requiredTechnologyIds: ['applied-chemistry'] }),
    dedicatedMethod({ id: 'tractor-orchard', nameTemplate: '{product:tractor}果园管理', iconId: 'tractor', descriptionTemplate: '每周期整件消耗 1 {product:tractor}并获得最高{product:fruit}产量。', tone: 'accent', additionalInputs: [{ productId: 'tractor', quantity: 1 }], outputQuantity: 15, requiredTechnologyIds: ['mechanized-production'] }),
  ]),
  ranch: Object.freeze([
    dedicatedMethod({ id: 'pasture-husbandry', name: '牧场放养', iconId: 'pasture', description: '采用牧场放养，不消耗额外生产资料。', tone: 'neutral', outputQuantity: 1 }),
    dedicatedMethod({ id: 'formula-feeding', nameTemplate: '{product:feed}精养', iconId: 'feed', descriptionTemplate: '每周期整件消耗 1 {product:feed}并提高养殖产量。', tone: 'warning', additionalInputs: [{ productId: 'feed', quantity: 1 }], outputQuantity: 4, requiredTechnologyIds: ['scientific-agriculture'] }),
    dedicatedMethod({ id: 'veterinary-care', name: '药剂精养', iconId: 'medicine', descriptionTemplate: '每周期整件消耗 1 {product:veterinary-medicine}并进一步提高畜产品产量。', tone: 'success', additionalInputs: [{ productId: 'veterinary-medicine', quantity: 1 }], outputQuantity: 8, requiredTechnologyIds: ['applied-chemistry'] }),
    dedicatedMethod({ id: 'mechanized-husbandry', name: '机械化畜牧', iconId: 'livestock-machine', descriptionTemplate: '每周期整件消耗 1 {product:machinery}并获得最高畜产品产量。', tone: 'accent', additionalInputs: [{ productId: 'machinery', quantity: 1 }], outputQuantity: 9, requiredTechnologyIds: ['mechanized-production'] }),
  ]),
  fishery: Object.freeze([
    ...
    dedicatedMethod({ id: 'formula-feeding', nameTemplate: '{product:feed}精养', iconId: 'feed', descriptionTemplate: '每周期整件消耗 1 {product:feed}并提高养殖产量。', tone: 'warning', additionalInputs: [{ productId: 'feed', quantity: 1 }], outputQuantity: 4, requiredTechnologyIds: ['scientific-agriculture'] }),
    dedicatedMethod({ id: 'veterinary-care', name: '药剂精养', iconId: 'medicine', descriptionTemplate: '每周期整件消耗 1 {product:veterinary-medicine}并进一步提高{product:fish}产量。', tone: 'success', additionalInputs: [{ productId: 'veterinary-medicine', quantity: 1 }], outputQuantity: 8, requiredTechnologyIds: ['applied-chemistry'] }),
    dedicatedMethod({ id: 'recirculating-aquaculture', name: '循环水养殖', iconId: 'water-cycle', descriptionTemplate: '每周期整件消耗 1 {product:machinery}并获得最高{product:fish}产量。', tone: 'accent', additionalInputs: [{ productId: 'machinery', quantity: 1 }], outputQuantity: 9, requiredTechnologyIds: ['mechanized-production'] }),
  ]),
  'logging-camp': Object.freeze([
    ...
    dedicatedMethod({ id: 'saw-assisted-logging', name: '锯具采伐', iconId: 'saw', descriptionTemplate: '每周期整件消耗 1 {product:tools}，提高{product:timber}采伐量。', tone: 'warning', additionalInputs: [{ productId: 'tools', quantity: 1 }], outputQuantity: 4, operatingCost: 6, requiredTechnologyIds: ['powered-production'] }),
    dedicatedMethod({ id: 'powered-logging', name: '动力采伐', iconId: 'powered-saw', descriptionTemplate: '{product:tools}配合{product:industrial-fuel}形成动力采伐线。', tone: 'success', additionalInputs: [{ productId: 'tools', quantity: 1 }, { productId: 'industrial-fuel', quantity: 1 }], outputQuantity: 5, operatingCost: 5, requiredTechnologyIds: ['powered-production'] }),
    dedicatedMethod({ id: 'mechanized-logging', name: '机械化采伐', iconId: 'logging-machine', descriptionTemplate: '{product:machinery}与{product:industrial-fuel}共同驱动最高强度采伐。', tone: 'accent', additionalInputs: [{ productId: 'machinery', quantity: 1 }, { productId: 'industrial-fuel', quantity: 2 }], outputQuantity: 7, operatingCost: 7.95, requiredTechnologyIds: ['mechanized-production', 'powered-production'] }),
  ]),
  mine: Object.freeze([
    ...
    dedicatedMethod({ id: 'drill-mining', name: '钻具开采', iconId: 'drill', descriptionTemplate: '每周期整件消耗 1 {product:tools}，提高矿石产量。', tone: 'warning', additionalInputs: [{ productId: 'tools', quantity: 1 }], outputQuantity: 4, operatingCost: 10, requiredTechnologyIds: ['powered-production'] }),
    dedicatedMethod({ id: 'blast-mining', name: '爆破开采', iconId: 'blast', descriptionTemplate: '{product:tools}与{product:industrial-chemicals}配合进行强化开采。', tone: 'success', additionalInputs: [{ productId: 'tools', quantity: 1 }, { productId: 'industrial-chemicals', quantity: 1 }], outputQuantity: 5, operatingCost: 9, requiredTechnologyIds: ['powered-production', 'applied-chemistry'] }),
    dedicatedMethod({ id: 'mechanized-mining', name: '机械化采矿', iconId: 'mining-machine', descriptionTemplate: '{product:machinery}、{product:industrial-chemicals}与{product:industrial-fuel}组成完整机械化矿山。', tone: 'accent', additionalInputs: [{ productId: 'machinery', quantity: 1 }, { productId: 'industrial-chemicals', quantity: 1 }, { productId: 'industrial-fuel', quantity: 1 }], outputQuantity: 6, operatingCost: 6.95, requiredTechnologyIds: ['mechanized-production', 'applied-chemistry', 'powered-production'] }),
  ]),
  'oil-field': Object.freeze([
    ...
    dedicatedMethod({ id: 'chemical-recovery', name: '化学驱油', iconId: 'chemical-pump', descriptionTemplate: '每周期整件消耗 1 {product:industrial-chemicals}提高采收率。', tone: 'warning', additionalInputs: [{ productId: 'industrial-chemicals', quantity: 1 }], outputQuantity: 3, operatingCost: 16, requiredTechnologyIds: ['applied-chemistry'] }),
    dedicatedMethod({ id: 'mechanical-recovery', name: '机械增产钻采', iconId: 'drilling-rig', descriptionTemplate: '{product:machinery}配合{product:industrial-chemicals}进行强化钻采。', tone: 'success', additionalInputs: [{ productId: 'machinery', quantity: 1 }, { productId: 'industrial-chemicals', quantity: 1 }], outputQuantity: 5, operatingCost: 15.45, requiredTechnologyIds: ['mechanized-production', 'applied-chemistry'] }),
    dedicatedMethod({ id: 'powered-drilling', name: '动力机械钻采', iconId: 'powered-rig', descriptionTemplate: '{product:machinery}、{product:industrial-chemicals}与{product:industrial-fuel}组成最高强度钻采体系。', tone: 'accent', additionalInputs: [{ productId: 'machinery', quantity: 1 }, { productId: 'industrial-chemicals', quantity: 1 }, { productId: 'industrial-fuel', quantity: 1 }], outputQuantity: 6, operatingCost: 18.95, requiredTechnologyIds: ['mechanized-production', 'applied-chemistry', 'powered-production'] }),
  ]),
  mill: Object.freeze([
    ...
    dedicatedMethod({ id: 'roller-milling', name: '辊式加工', iconId: 'roller', descriptionTemplate: '扩大原料批量并整件消耗{product:tools}进行辊式加工。', tone: 'warning', baseInputQuantities: [4], additionalInputs: [{ productId: 'tools', quantity: 1 }], outputQuantity: 2, operatingCost: 5.2, requiredTechnologyIds: ['powered-production'] }),
    dedicatedMethod({ id: 'mechanical-processing', name: '机械加工', iconId: 'gear', descriptionTemplate: '扩大原料批量并整件消耗{product:machinery}进行加工。', tone: 'success', baseInputQuantities: [6], additionalInputs: [{ productId: 'machinery', quantity: 1 }], outputQuantity: 3, operatingCost: 10.25, requiredTechnologyIds: ['mechanized-production'] }),
    dedicatedMethod({ id: 'continuous-processing', name: '连续化加工', iconId: 'conveyor', descriptionTemplate: '{product:machinery}与{product:industrial-fuel}驱动连续化加工线。', tone: 'accent', baseInputQuantities: [6], additionalInputs: [{ productId: 'machinery', quantity: 1 }, { productId: 'industrial-fuel', quantity: 1 }], outputQuantity: 4, operatingCost: 18.25, requiredTechnologyIds: ['mechanized-production', 'powered-production'] }),
  ]),
  sawmill: Object.freeze([
    ...
    dedicatedMethod({ id: 'saw-line', name: '锯具流水线', iconId: 'saw-line', descriptionTemplate: '扩大{product:timber}批量并整件消耗{product:tools}形成锯切流水线。', tone: 'warning', baseInputQuantities: [8], additionalInputs: [{ productId: 'tools', quantity: 1 }], outputQuantity: 4, operatingCost: 4, requiredTechnologyIds: ['powered-production'] }),
    dedicatedMethod({ id: 'mechanical-sawmilling', name: '机械制材', iconId: 'gear-saw', descriptionTemplate: '{product:machinery}提高{product:timber}利用率与制材吞吐。', tone: 'success', baseInputQuantities: [7], additionalInputs: [{ productId: 'machinery', quantity: 1 }], outputQuantity: 4, operatingCost: 4.45, requiredTechnologyIds: ['mechanized-production'] }),
    dedicatedMethod({ id: 'continuous-sawmilling', name: '动力连续制材', iconId: 'conveyor-saw', descriptionTemplate: '{product:machinery}与{product:industrial-fuel}驱动连续制材线。', tone: 'accent', baseInputQuantities: [8], additionalInputs: [{ productId: 'machinery', quantity: 1 }, { productId: 'industrial-fuel', quantity: 1 }], outputQuantity: 5, operatingCost: 10.45, requiredTechnologyIds: ['mechanized-production', 'powered-production'] }),
  ]),
  'feed-factory': Object.freeze([
    ...
    dedicatedMethod({ id: 'tool-assisted-mixing', name: '工具辅助配料', iconId: 'tool-mixer', descriptionTemplate: '扩大原料批量并整件消耗{product:tools}辅助配料。', tone: 'warning', baseInputQuantities: [4, 2], additionalInputs: [{ productId: 'tools', quantity: 1 }], outputQuantity: 5, operatingCost: 3.6, requiredTechnologyIds: ['powered-production'] }),
    dedicatedMethod({ id: 'mechanical-mixing', name: '机械混配', iconId: 'gear-mixer', descriptionTemplate: '{product:machinery}完成大批量稳定混配。', tone: 'success', baseInputQuantities: [6, 3], additionalInputs: [{ productId: 'machinery', quantity: 1 }], outputQuantity: 8, operatingCost: 10.75, requiredTechnologyIds: ['mechanized-production'] }),
    dedicatedMethod({ id: 'continuous-mixing', name: '动力连续混配', iconId: 'conveyor-mixer', descriptionTemplate: '{product:machinery}与{product:industrial-fuel}驱动连续混配生产线。', tone: 'accent', baseInputQuantities: [8, 4], additionalInputs: [{ productId: 'machinery', quantity: 1 }, { productId: 'industrial-fuel', quantity: 1 }], outputQuantity: 11, operatingCost: 18.95, requiredTechnologyIds: ['mechanized-production', 'powered-production'] }),
  ]),
