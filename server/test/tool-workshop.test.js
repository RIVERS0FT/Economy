...
test('工具与工具工坊进入正式目录并保持 C4 参考利润', () => {
  assert.equal(PRODUCT_CATALOG.length, 36); assert.equal(FACILITY_TYPE_CATALOG.length, 26); assert.equal(ECONOMY_CONSTANTS.maxOpenOrders, (PRODUCT_CATALOG.length + FACILITY_TYPE_CATALOG.length) * 10);
