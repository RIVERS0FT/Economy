...
for (const [label, extra] of [
...
]) test(`retired automatic sell rejects ${label} without an asset mutation`, () => {
  ...
  const result = applyOnlineAutoSell(world, user, { provinceId: '110000', productId: 'wheat', ...extra }, now);
