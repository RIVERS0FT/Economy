...
// The screenshot recorder adds compositor readbacks to changing frames. Keep
// action and DOM traces for this Camera suite without recording a screencast.
// Trace is worker-scoped and must be configured at file scope, not in describe.
