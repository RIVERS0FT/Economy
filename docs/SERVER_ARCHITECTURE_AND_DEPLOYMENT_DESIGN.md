...
- 世界版本 15／客户端状态版本 17 的历史人口迁移与当前世界版本 16／客户端状态版本 19 都只执行一次人口启动发行，旧施工费不得追溯补发；
