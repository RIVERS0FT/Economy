    ...
    case 'fertilizer':
      return (
        <ProductSvg productId={productId} {...props}>
          ...
          <path d="M5 9h14M9 5l1-2h4l1 2" />
          <path d="M9 15c1.8-2.7 4.5-3.6 7-2.7-.5 2.8-2.5 4.6-6 5" />
          <path d="M11 17c-.1-2.1.8-3.8 2.8-5.2" />
