...
const badgeComponentPath = 'src/components/ui/NavigationBadge.tsx';
const badgeModelPath = 'src/navigation/navigationBadges.ts';
...
for (const text of [
  ...
  'navigation badge caps visible counts at 99+',
  'auction and contract badges merge unique objects and keep persistent attention after visiting',
