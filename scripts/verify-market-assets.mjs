...
for (const text of ['assetKind','matchFacilityOrder','reduceRunningGroupForSellOrder','valuationPricesFor','bestBidFor','world.version = 7','reconcileFacilityGroup','pendingProductionPlan','removeSystemFacilityOrders']) requireText('server/src/facility-groups.js', text);
