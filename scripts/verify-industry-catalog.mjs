...
assert.equal(PRODUCT_CATALOG.length, 13, '商品目录必须包含 13 项');
...
for (const [path, required] of [
  ['README.md', ['当前目录共 13 种商品和 12 种工厂类型', '小麦 → 面粉 → 食品', '水稻', '木材 → 木板 → 家具']],
  ['docs/INDUSTRY_AND_PRODUCTION_DESIGN.md', ['当前基线为 13 种商品', '当前基线为 12 种工厂类型', '旧存档自动补齐新增商品库存', 'wheat-crop', 'rice-crop']],
...
console.log('产业目录验证通过：13 种商品、12 种工厂、小麦水稻与农场配方、全商品 SVG 和动态目录布局均满足设计。');
