...
for (const path of [
  ...
  'server/test/commodity-investment-runtime.test.js',
...
for (const source of [
  ...
  'server/src/commodity-investment-runtime.js',
  'server/src/commodity-investment-audit.js',
  'server/src/commodity-investment-ledger.js',
  'server/src/commodity-investment-assessment.js',
