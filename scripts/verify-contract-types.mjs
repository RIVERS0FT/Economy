...
requireText('server/src/contracts.js', ['PRODUCTION_CONTRACT_SCHEMA_VERSION = 9', 'confirmDefault', 'confirmMarketReserveBuyerDefault', 'claimConfirmedDefault', 'breachedAt', 'processCommercialContract', 'publicCommercialContract']);
