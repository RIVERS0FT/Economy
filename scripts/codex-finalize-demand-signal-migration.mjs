...
const verifierSource = readFileSync('scripts/verify-staple-crops-demand.mjs', 'utf8');
if (!verifierSource.includes(docsAnchor)) throw new Error('verify-staple-crops-demand.mjs: docs anchor missing');
...
writeFileSync(
  'scripts/verify-staple-crops-demand.mjs',
  verifierSource.replace(docsAnchor, docChecks + docsAnchor),
);
