...
assert.match(read('server/shared/economy-state-version.js'), /CURRENT_CLIENT_STATE_VERSION = 42/);
assert.match(read('server/shared/economy-state-version.js'), /MIN_COMPATIBLE_CLIENT_STATE_VERSION = 42/);
...
assert.match(read('server/src/world-storage-v2.js'), /AUTHORITATIVE_WORLD_VERSION = 33/);
...
assert.match(read('docs/README.md'), /`SERVER_ARCHITECTURE_AND_DEPLOYMENT_DESIGN\.md`/);
