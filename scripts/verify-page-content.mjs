...
for (const text of [
  ...
  '图标式快捷生产设置',
  '`ProvincePage` 内的市场、商业与工业分区始终是地图所打开当前州的本地视图',
  '概览始终显示官方常住人口',
...
for (const [path, expected] of [
  ...
  ['src/pages/GlobalBuildingsPage.tsx', [
    ...
    'resolveFacilityDetailRecipeState({ group: recipeConfiguration.project(group), type })',
    'resolveFacilityDetailRecipeState({ group: recipeConfiguration.project(group), type: selectedGlobalFacility })',
