...
requireText('server/src/runtime-store.js', ['flushAuctionAuditEvents(this, world, revision, nextRevision);', 'prepared.version = 23;']);
...
requireText('docs/README.md', ['客户端状态版本：26', '世界状态版本：23']);
