...
for (const [path, required] of [
  ...
  ['src/pages/MarketPage.tsx', [
    ...
    'buyFacility(listing.id, purchaseQuantity)', 'cancelOrder(order.id)',
  ]],
  ['src/pages/ProductionPage.tsx', [
  ...
  ['src/utils/localActivityStore.ts', ['STORAGE_VERSION = 2', 'facilityGroups: state.facilityGroups', 'diffFacilityGroups', '工厂数量市场']],
...
console.log('UI 架构验证通过：统一组件、页面职责、工厂集群和紧凑市场满足设计基线。');
