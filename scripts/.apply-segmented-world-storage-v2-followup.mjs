...
const runtimeHotpath = `import assert from 'node:assert/strict';
...
`;
write('server/test/runtime-hotpath-architecture.test.js', runtimeHotpath);
...
console.log('segmented world storage v2 follow-up applied');
