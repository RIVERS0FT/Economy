...
Economy 是一款网页端多人在线经济模拟、产业经营、统一资产交易与藏品／商品／工厂竞价拍卖游戏。
...
- 藏品、商品和工厂均可采用公开竞价拍卖；卖方资产与最高出价资金同时冻结，被超价时自动释放资金，结束后服务器自动结算并转移资产。商品最高出价预占仓库，工厂拍卖冻结数量退出生产；拍卖成交价不写入订单簿行情或估值。
...
- 拍卖：选择藏品、商品或工厂发起竞价，取消无出价拍卖并查看自动结算结果。
- 排行：服务器总资产排行榜。
- 宝石商店：按服务器固定汇率将宝石单向兑换为普通货币，并查看最近兑换记录。
- 设置：玩家资料、偏好、宝石、分享链接、邀请码、礼品兑换、退出与重置。客户端偏好只显示已实现的“紧凑数字”和 3s／5s／10s 状态刷新频率。
