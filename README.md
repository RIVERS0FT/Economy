...
Economy 是一款以生产、交易和资产配置为核心的多人在线经济模拟游戏。玩家从基础收入和启动资金出发，在中国 34 个省级地区切换经营位置，建设或买入当地工厂，选择生产配方，管理本地无限仓库与现金流，并在省级本地市场中交易商品和工厂资产。
...
- **中国省级经营地图**：34 个省级地区均可点击；每个地区拥有独立商品库存、工厂集群、商品行情和工厂行情，跨地区订单不会撮合。
- **本地统一资产市场**：同一省级地区的商品与工厂使用统一限价订单体系，支持真实冻结、撮合、成交和估值。
...
| `npm run verify:provincial-economy` | 验证 34 个地区、本地市场、仓库、工厂和地图边界 |
